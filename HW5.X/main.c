...
void writeUART10(const char * string);
void UART_init();
...
void UART_init(){
    ...
    //Error with screen program solved using this source: https://superuser.com/questions/1345069/screen-a-serial-get-could-not-find-a-pty-error
