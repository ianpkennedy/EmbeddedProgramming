...
void ws2812b_setColor(wsColor * c, int numLEDs) {
    ...
    volatile unsigned int delay_times[2*3*8 * (numLEDs+1)]; // MODIFIED FROM 5 . I only gave you 5 WS2812B, adjust this if you get more somewhere
